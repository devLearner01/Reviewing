...
public class InnerClassing {

	private static List<AlbumWithInnerClass> albumList = new ArrayList<AlbumWithInnerClass>();
	private static List<Song> playList = new LinkedList<Song>();

	public static void songManagerWithInnerClass() {
		...
		private static void addSongs2PlayList() {
			...
			playList.add( albumList.get( 0 ).getSongbyIndex( 0 ) );
			playList.add( albumList.get( 0 ).getSongbyIndex( 1 ) );
			playList.add( albumList.get( 2 ).getSongbyIndex( 0 ) );
			playList.add( albumList.get( 1 ).getSongbyIndex( 2 ) );
			playList.add( albumList.get( 2 ).getSongbyIndex( 3 ) );
		}

		private static void createAlbums(){
			AlbumWithInnerClass album1 = new AlbumWithInnerClass();
			...
			AlbumWithInnerClass album2 = new AlbumWithInnerClass();
			...
			AlbumWithInnerClass album3 = new AlbumWithInnerClass();
